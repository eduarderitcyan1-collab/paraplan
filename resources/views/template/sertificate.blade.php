<div class="container sertificate">
    <h2 class="subTitle">Сертификат, подтверждающий Ваш полёт на параплане</h2>
    <p class="text">Мы - единственная компания, которая выдает сертификаты после полёта</p>
    <div class="swiper sertificateSwiper">
            ...
            @foreach ($sertificates as $sertificate)
                <div class="swiper-slide">
                    ...
                    <div class="sertificateContent">
                        ...
                        <div class="sertificatePrice">{{ $sertificate->price }} ₽</div>
                    </div>
                </div>
            @endforeach
        </div>
        @if (count($sertificates) >= 4)
            <div class="swiperNavigation">
                ...
                <div class="swiper-button-next sertificate-next glass">
                    <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27"
                        fill="none">
