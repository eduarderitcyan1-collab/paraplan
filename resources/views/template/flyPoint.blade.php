...
<div class="swiperNavigation swiperMobileNavigation">
    <div class="swiper-button-prev flyPoint-prev glass">
    ...
    <div class="swiper-button-next flyPoint-next glass">
        <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 27" fill="none">
...
<a href="{{ $routsMain ? route('routes.show', $routsMain->slug) : '#' }}" class="flyPointContentOther">
    <div class="flyPointContent">
        <img src="{{ asset('storage/' . $routsMain?->photo) }}" alt="Fly Point" class="flyPointPhoto">
        <div class="flyPointName glass">
