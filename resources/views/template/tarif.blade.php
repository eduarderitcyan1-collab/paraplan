        ...
        <div class="swiper-wrapper">
            @foreach ($tarifs as $tarif)
                <div class="swiper-slide glass modalButton">
                    <img src="{{ asset('storage/' . $tarif->img) }}" alt="Tarif" class="tarifPhoto">
                    <div class="tarifWrapper">
                        <div class="tarifContent">
                            <div class="tarifTitle">{{ $tarif->title }}</div>
                            <p class="text">({{ $tarif->time }} минут)</p>
                        </div>
                        <div class="tarifPrice">{{ $tarif->price }} ₽</div>
                    </div>
