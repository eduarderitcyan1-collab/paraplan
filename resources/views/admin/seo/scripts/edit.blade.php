<x-app-layout>
    <div class="max-w-3xl mx-auto py-10 px-6 space-y-6">
        <div class="flex items-center justify-between gap-3 flex-wrap">
            <h1 class="text-2xl font-bold text-gray-800">Редактировать скрипт</h1>
        ...
        <div class="bg-white shadow rounded-xl p-6">
            <form action="{{ route('external-services.update', $externalService) }}" method="POST" class="space-y-4">
                @csrf
                @method('PUT')
